<x-head/>
    <body>
        ...
        <main>
            ...
            <form method="POST" action="/achat/verifierCarteBancaire" class="needs-validation" novalidate>
                @csrf
                <div class="d-flex flex-row justify-content-center mt-5">
                    <label for="InputcarteBancaire" class="form-label fs-2">Vous devez indiquez N° de votre carte bancaire</label>
                </div>
                <div class="d-flex flex-row justify-content-center">
                    <div class="my-2">
                        <input type="text" class="form-control" id="InputcarteBancaire" maxlength="16" size="25" name="carte bancaire" required>
                    </div>
                </div>
